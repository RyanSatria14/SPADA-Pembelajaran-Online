...
<head>
  ...
  <title>SPADA | <?=$data['nama_lengkap']; ?></title>
  <!-- plugins:css -->
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              <a class="dropdown-item">
                <p class="mb-0 font-weight-normal float-left"> Pemberitahuan Sistem
                </p>
            ...
            <div class="collapse" id="masterData" style="background-color:#212121;">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                    ...
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title">Jenis Perangkat</span></a>
               </li>
