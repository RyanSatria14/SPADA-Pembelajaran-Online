...
<head>
  ...
  <title>SPADA | <?=$data['nama_siswa']; ?></title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
          	<a class="nav-link" href="?page=profil"><img class="menu-icon" src="../vendor/images/menu_icons/profile.png" alt="menu icon"> <span class="menu-title">My Profil</span></a>
          </li>
           ...
           <li class="nav-item">
            ...
            <?php } ?>
               ...
               <li class="nav-item">
          <a class="nav-link" href="?page=tugas"><img class="menu-icon" src="../vendor/images/menu_icons/tugas.png" alt="menu icon"> <span class="menu-title">TUGAS </span></a>
          </li>

          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#menuEvaluasi" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/evaluasi.png" alt="menu icon"> <span class="menu-title">EVALUASI</span><i class="menu-arrow"></i>
            </a>
