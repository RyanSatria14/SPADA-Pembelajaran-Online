...
<!-- style="overflow:scroll;height:600px;border-radius:10px;background-color:#fff;border:7px solid;" -->
    ...
    <div class="mt-3">
    <h4><b><i class="fa fa-wechat text-success"></i></b> <b class="text-success">Pesan</b></h4>
            ...
            <form action="" method="post">
                <div class="modal-body"> 
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="isi_pesan" id="ckeditor" class="form-control" rows="5"> </textarea>
                  </div>
...
<form action="" method="post">
  <div class="form-group">
    ...
    <option required="">Kirim Ke</option>
    <?php
   ...
   <div class="form-group">
    ...
    <textarea name="pesan" class="form-control" rows="5" id="ckeditor1" placeholder="Ketik Pesan..." required=""></textarea>
  </div>
    <div class="form-group">
      ...
      <!-- cek Jika ketersediaan ujian Objektif -->
        ...
        <div class="card" style="overflow: scroll;min-height: 600px;">
                <div class="card-body">
                  <h6 class="card-title">Status Aktivitas Siswa</h6>
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <!--<td>
                          <a href="" class="btn btn-warning btn-xs"><i class="fa fa-undo"></i><strong><font color="#000000">Refresh</font></strong></a>
                        </td>-->
                         <!--<td> <img src="../vendor/images/img_Siswa/<?=$s['foto']; ?>" alt="image" style=" border-radius: 100%;width: 30px;height: 30px;"/></td>-->
                        <td><?=$s['nama_siswa']; ?><strong><br>(<?=$s['kelas']; ?>-<?=$s['jurusan']; ?>)</strong></br></td>
                        ...
                        <td>
                          ...
                          if ($s['status']=='off') {
                            ...
                            ?>
                            <label class="btn btn-success btn-xs"> <?=$s['status']; ?></label>
                            <?php
