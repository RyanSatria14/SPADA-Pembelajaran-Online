...
<head>
  ...
  <title>SPADA | <?=$data['nama_guru']; ?></title>
  <!-- plugins:css -->
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="../vendor/images/TEKNOKRAT.png" />
...
<body>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center" style="background-color: #6A5ACD">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
          	<a class="nav-link" href="index.php"><img class="menu-icon" src="../vendor/images/menu_icons/dasbot.png" alt="menu icon"><span class="menu-title">DASHBOARD</span></a>
          </li>
        ...
        <!--   <li class="nav-item">
             ...
             <li class="nav-item">
            <a class="nav-link" href="?page=mapel"><img class="menu-icon" src="../vendor/images/menu_icons/mapel.png" alt="menu icon"> <span class="menu-title">MATA PELAJARAN</span></a>
          </li>
         ...
         <li class="nav-item">
            ...
            <div class="collapse" id="materi">
              ...
              <i class="fa fa-file-text"></i> &nbsp;&nbsp;SEMUA MATERI</a>
               ...
               <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#tugas" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/lembar.png" alt="menu icon"> <span class="menu-title">TUGAS SISWA</span><i class="menu-arrow"></i>
            </a>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#evaluasi" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/doc.png" alt="menu icon"> <span class="menu-title">UJIAN SISWA</span><i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="evaluasi">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                 	 <a class="nav-link" href="?page=ujian"><img class="menu-icon" src="../vendor/images/menu_icons/06.png" alt="menu icon"> <span class="menu-title">BUAT UJIAN</span></a>
             	</li>
                <li class="nav-item">
                 	 <a class="nav-link" href="?page=nilai"><img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">NILAI UJIAN</span></a>
             	</li>
             	</li>
              </ul>
            </div>
          ...
          <center><li class="btn btn-info">
            <a class="nav-link" href="logout.php"><font color="#FFFFFF"><strong>
